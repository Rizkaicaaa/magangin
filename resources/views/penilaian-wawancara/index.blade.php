...
<div class="bg-white p-8 rounded-xl shadow-lg mx-6">
    ...
    @endif
                    ...
                    <td class="py-3 px-4 flex gap-2">
                        {{-- Tombol Detail --}}
                            <a href="{{ route('penilaian-wawancara.show', $item->id) }}" class="text-green-600 hover:text-green-800" title="Detail">
                                <!-- Icon Eye -->
                        ...
                        {{-- Tombol Edit --}}
                        <a href="{{ route('penilaian-wawancara.edit', $item->id) }}" class="text-blue-600 hover:text-blue-800" title="Edit">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
