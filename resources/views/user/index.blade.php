...
<div class="bg-white p-8 rounded-xl shadow-lg mx-6">
    ...
    <div id="content-container">
        ...
        {{-- ========================================================== --}}
        <h2 class="text-2xl font-semibold text-gray-700 mb-4 mt-8 {{ $hasAdminData ? '' : 'hidden' }}">Admin & Super Admin</h2>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @foreach($adminUsers as $user)
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ \Carbon\Carbon::parse($user->created_at)->format('d F Y') }}</td>
        ...
        {{-- ========================================================== --}}
        <h2 class="text-2xl font-semibold text-gray-700 mb-4 mt-8 {{ $hasMahasiswaData ? '' : 'hidden' }}">User Mahasiswa</h2>
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        function manageView() {
            ...
            const totalDataRows = {{ count($users) }}; // Menggunakan variabel Blade
        ...
        const setupCreateForm = () => {
            ...
            document.getElementById('password').setAttribute('required', 'required'); // Pastikan password required saat membuat user baru
            ...
            button.addEventListener('click', (e) => {
                ...
                fetch(`/users/${id}/edit`)
                    ...
                    .then(data => {
                        ...
                        const methodFieldHtml = `<input type="hidden" name="_method" value="PUT" id="method_field">`;
