<nav x-data="{ open: false, showLogoutModal: false }"
        ...
        <div class="flex items-center justify-between h-14 w-full">
            ...
            <div class="flex items-center group flex-shrink-0">
                <a href="{{ route('dashboard') }}" class="flex items-center gap-1.5">
                    <div
                        class="bg-gradient-to-br from-white to-white-700 rounded-full p-1 group-hover:scale-105 transition-transform duration-200">
                        <img src="{{ asset('images/logomagangin.png') }}" alt="Logo MagangIn"
                            class="h-6 w-6 object-contain">
                    </div>
                    <div class="hidden lg:block">
                        <h2
                            class="text-sm font-semibold text-gray-900 group-hover:text-blue-600 transition-colors leading-tight">
                            MagangIn
                        </h2>
                        <p class="text-[9px] text-gray-500 leading-tight">BEM KM FTI UNAND</p>
                    </div>
                </a>
            </div>
            ...
            <div class="hidden md:flex items-center justify-center flex-1 px-2">
                <div class="flex items-center space-x-1">
                    ...
                    <a href="{{ route('dashboard') }}"
                        class="inline-flex items-center justify-start whitespace-nowrap px-2 py-1.5 text-sm font-medium transition-all duration-200 rounded-lg
                    ...
                    <a href="{{ route('info-or.index') }}"
                        ...
                        <i class="fas fa-info-circle mr-1.5"></i> Info OR
                    </a>
                    ...
                    <a href="{{ route('pendaftar.index') }}"
                        ...
                        <i class="fas fa-users mr-1.5"></i> Data Pendaftar
                    </a>
                    ...
                    <div class="relative" x-data="{ open: false }">
                        <button @click="open = !open"
                            ...
                            <i class="fas fa-clipboard-list mr-1.5 text-sm"></i>
                        ...
                        <div x-show="open" x-cloak @click.away="open = false" x-transition
                            class="absolute right-0 z-50 mt-1 w-64 rounded-xl bg-white shadow-xl ring-1 ring-black/5 border border-gray-100"
                            ...
                            <div class="py-1">
                                <a href="{{ route('jadwal-seleksi.index') }}"
                                    ...
                                    <i class="fas fa-calendar-alt text-green-600 mr-2"></i> Jadwal Wawancara
                                </a>
                                <a href="{{ route('penilaian-wawancara.index') }}"
                                    ...
                                    <i class="fas fa-clipboard-check text-yellow-600 mr-2"></i> Penilaian Wawancara
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <a href="{{ route('jadwal-kegiatan.index') }}"
                        ...
                        <i class="fas fa-tasks mr-1.5"></i> Jadwal Kegiatan
                    </a>
                    ...
                    <a href="{{ route('penilaian.index') }}"
                        ...
                        <i class="fas fa-star mr-1.5"></i> Penilaian Magang
                    </a>

                    <a href="{{ route('users.index') }}"
                        class="inline-flex items-center justify-start whitespace-nowrap px-2 py-1.5 text-sm font-medium transition-all duration-200 rounded-lg
                        {{ request()->is('users*') ? 'text-blue-600 bg-blue-50 font-semibold shadow-sm' : 'text-gray-700 hover:text-blue-600 hover:bg-blue-50' }}">
                        <i class="fas fa-user-cog mr-1.5"></i> Kelola User
                    </a>

                    @elseif(Auth::user()->role == 'admin')
                    <a href="{{ route('dashboard') }}"
                        class="inline-flex items-center px-2 py-1.5 text-sm font-medium transition-all duration-200 rounded-lg
                        {{ request()->routeIs('dashboard') ? 'text-blue-600 bg-blue-50 font-semibold shadow-sm' : 'text-gray-700 hover:text-blue-600 hover:bg-blue-50' }}">
                        <i class="fas fa-tachometer-alt mr-1.5"></i> Dashboard
                    </a>
                    ...
                    <a href="{{ route('jadwal-kegiatan.index') }}"
                        class="inline-flex items-center px-2 py-1.5 text-sm font-medium transition-all duration-200 rounded-lg
                        {{ request()->is('jadwal-kegiatan*') ? 'text-blue-600 bg-blue-50 font-semibold shadow-sm' : 'text-gray-700 hover:text-blue-600 hover:bg-blue-50' }}">
                        <i class="fas fa-calendar-alt mr-1.5"></i> Jadwal Kegiatan
                    </a>
                    ...
                    <a href="{{ route('mahasiswa.jadwal-seleksi') }}"
                        ...
                        <i class="fas fa-calendar-check mr-1.5"></i> Jadwal Wawancara
                    </a>
                    ...
                    <a href="{{ route('kelulusanwawancara.index') }}"
                        ...
                        <i class="fas fa-clipboard-check mr-1.5"></i> Kelulusan Wawancara
                    </a>
                    ...
                    <a href="{{ route('kelulusan-magang.index') }}"
                        class=" inline-flex items-center px-2 py-1.5 text-sm font-medium transition-all duration-200
                        ...
                        <i class="fas fa-graduation-cap mr-1.5"></i> Kelulusan Magang
                    </a>
                    @endif
                </div>
            </div>
            ...
            <div class="flex items-center flex-shrink-0">
                <div class="relative" x-data="{ open: false }">
                    <button @click="open = !open"
                        class="inline-flex items-center px-1.5 py-1 border border-transparent text-sm font-medium rounded-lg text-gray-600 bg-white hover:text-blue-600 hover:bg-blue-50 focus:outline-none focus:ring-1 focus:ring-blue-500 transition-all duration-150">
                        <div class="flex items-center gap-2">
                            <div
                                class="w-8 h-8 rounded-full overflow-hidden flex items-center justify-center bg-gray-100">
                                <img src="{{ asset(path: 'images/profile-icon.jpeg') }}" alt="User Avatar"
                                    class="w-full h-full object-cover object-center">
                            </div>
                            <div class="hidden lg:block text-left">
                                <div class="font-medium text-gray-900 text-sm truncate max-w-[100px]">
                                    {{ Auth::user()->name }}
                                </div>
                            ...
                            <svg class="fill-current h-3 w-3 text-gray-400 transition-transform duration-200"
                    ...
                    <div x-show="open" x-cloak @click.away="open = false"
                        ...
                        class="absolute right-0 z-50 mt-1 w-56 origin-top-right rounded-lg bg-white shadow-lg border border-gray-200">
                        ...
                        <div class="px-4 py-2 border-b border-gray-100 flex items-center gap-3">
                            ...
                            <div>
                                ...
                                @if(Auth::user()->role)
                                <div class="text-[10px] text-blue-600 font-medium capitalize mt-0.5">
                                    {{ Auth::user()->role }}
                                </div>
                                @endif
                            </div>
            ...
            <div class="flex items-center md:hidden">
                <button @click="open = ! open"
                    class="inline-flex items-center justify-center p-1.5 rounded-md text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 focus:text-gray-500 transition duration-150 ease-in-out">
    ...
    <div :class="{'block': open, 'hidden': ! open}"
        ...
        <div class="px-2 pt-2 pb-3 space-y-1">
            ...
            'pendaftar*'],
            ['url' => '/jadwal-kegiatan', 'label' => 'Jadwal Kegiatan', 'icon' => 'fas fa-tasks', 'pattern' =>
            'jadwal-kegiatan*'],
