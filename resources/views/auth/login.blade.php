        ...
        <div class="poster-container hidden lg:flex lg:w-1/2 xl:w-3/5 justify-center items-center">
            ...
            <div class="info-list">
                ...
                <div class="relative max-w-lg" x-data="{ open: false }">
                    <img src="{{ asset( $infoOr->gambar ) }}" alt="Poster MagangIn"
                    ...
                    <div x-show="open" class="fixed inset-0 z-50 flex justify-center items-center"
                        style="display: none;">
                        ...
                        <div x-show="open" x-transition:enter="ease-out duration-300"
                            ...
                            <h4 class="font-bold text-xl mb-4 text-gray-800 border-b pb-2">Detail {{ $infoOr->judul }}
                            </h4>
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="flex items-start">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-800 mt-1">
                                            {{ ucwords(strtolower($infoOr->deskripsi)) }}</p>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-start">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-800 mt-1">
                                            {{ ucfirst(strtolower($infoOr->persyaratan_umum)) }}</p>
                                    </div>
                                </div>
                ...
                @else
                <p class="text-gray-500 text-sm">Maaf, belum ada informasi OR Magang BEM FTI.</p>
                @endif
            </div>
        </div>
        ...
        <div class="w-full lg:w-1/2 xl:w-2/5 max-w-lg mx-auto">
            <div
                ...
                <div class="flex bg-gray-100 rounded-xl p-1 mb-4 w-full max-w-sm mx-auto">
                    ...
                    <button id="registerTab" @if (!isset($infoOr) || strtolower($infoOr->status) == 'tutup') disabled
                        @endif

                        class="flex-1 py-2 px-3 rounded-lg text-sm font-medium transition-all duration-300
                        {{-- Styling tombol diubah berdasarkan status --}}
                        @if (isset($infoOr) && strtolower($infoOr->status) == 'buka')
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <button type="button"
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 closed-eye" fill="none"
                                            viewBox="0 0 24 24" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.878 9.878L3 3m6.878 6.878L21 21" />
                                        </svg>
                                        <!-- Mata terbuka (ketika password terlihat) -->
                                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 open-eye hidden"
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <button type="button"
                                            class="absolute right-4 top-1/2 transform -translate-y-1/2 text-gray-400 hover:text-gray-600 toggle-password">
                                            <!-- Mata tertutup (default) -->
                                            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 closed-eye"
                                                fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                    d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.878 9.878L3 3m6.878 6.878L21 21" />
                                            </svg>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.addEventListener('click', (e) => {
        ...
        // Toggle ikon sesuai best practice
        if (isPassword) {
            // Password sekarang terlihat → tampilkan mata terbuka
            openEye.classList.remove('hidden');
            closedEye.classList.add('hidden');
        } else {
            // Password sekarang disamarkan → tampilkan mata tertutup
