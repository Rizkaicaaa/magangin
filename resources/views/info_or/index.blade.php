...
@section('content')
    ...
    <div class="bg-white p-8 rounded-xl shadow-lg mx-6">
        ...
        <div id="open-info-alert" class="bg-yellow-100 border-l-4 border-yellow-500 text-yellow-700 p-4 mb-6 rounded-lg" role="alert">
            <p class="font-bold">Info OR Sedang Aktif</p>
            <p class="text-sm">Anda hanya dapat membuat Info OR baru setelah Info OR yang saat ini berstatus "buka" ditutup.</p>
        </div>
        @endif
